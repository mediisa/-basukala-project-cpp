...
private:
    ...
    std::string status;
public:
    Order(const std::string& id , const std::string& username , const std::vector<OrderItem>& items , 
...
public:
    Package();
    Package(const std::string& id , const std::string& orderId , const std::string& username ,
