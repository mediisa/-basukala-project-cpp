...
🛒 Basukala
Project Goal
Creating a simple and efficient store system that:
- Allows users to view, search, and purchase products
- Enables managers to manage products and process orders
